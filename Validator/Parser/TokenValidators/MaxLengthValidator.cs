...
{
    internal class MaxLengthValidator : ITokenValidator
    {
        private readonly INonNegativeIntegerValueValidator _nonNegativeIntegerValueValidator;

        public MaxLengthValidator(INonNegativeIntegerValueValidator nonNegativeIntegerValueValidator)
        {
            _nonNegativeIntegerValueValidator = nonNegativeIntegerValueValidator;
        }

        public TokenName TokenName => new TokenName(new MaxLengthKeyword().Keyword);
